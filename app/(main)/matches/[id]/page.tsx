...
const MARKET_GROUP_ORDER = [
  ...
  { key: 'spreads',             label: 'Handicap / Spread' },
  // ── Basketball (NBA / WNBA / NCAA) ───────────────────────────────────────────
  { key: 'h2h_1h',              label: '1st Half - Moneyline' },
  { key: 'totals_1h',           label: '1st Half Total Points' },
  { key: 'totals_2h',           label: '2nd Half Total Points' },
  { key: 'totals_1q',           label: '1st Quarter Total' },
  { key: 'totals_2q',           label: '2nd Quarter Total' },
  { key: 'totals_3q',           label: '3rd Quarter Total' },
  { key: 'totals_4q',           label: '4th Quarter Total' },
  { key: 'h2h_1q',              label: '1st Quarter - Moneyline' },
  // ── Baseball (MLB) ───────────────────────────────────────────────────────────
  { key: 'h2h_f5',              label: 'First 5 Innings - Moneyline' },
  { key: 'totals_f5',           label: 'First 5 Innings Total' },
  // ── Ice Hockey (NHL) ─────────────────────────────────────────────────────────
  { key: 'h2h_regulation',      label: 'Regulation - 3-Way' },
  { key: 'totals_p1',           label: '1st Period Total' },
  { key: 'totals_p2',           label: '2nd Period Total' },
  { key: 'totals_p3',           label: '3rd Period Total' },
  // ── Soccer ───────────────────────────────────────────────────────────────────
