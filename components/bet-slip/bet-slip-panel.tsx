...
export function BetSlipPanel() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-72 shadow-2xl rounded-xl border border-border bg-background overflow-hidden animate-in slide-in-from-bottom-4">
      {/* Header toggle */}
      <button
