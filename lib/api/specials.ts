 ...
 * and other proposition bets aggregated from UK & African bookmakers.
 *
 * Updated: June 2026. Prices are best-available from Paddy Power / Coral / Betway / bet365.
 * Note: Man City confirmed Enzo Maresca as manager Jun 2026.
 */
...
export const SPECIALS: Special[] = [
  ...
  {
    id: 'wc2026-top-assist',
    title: 'FIFA World Cup 2026 — Most Assists',
    subtitle: 'Tournament creator award',
    category: 'World Cup 2026',
    slug: 'world-cup-2026-top-assist',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Lamine Yamal',     price: 5.00, bookmaker: 'Paddy Power' },
      { name: 'Kevin De Bruyne',  price: 6.00, bookmaker: 'bet365' },
      { name: 'Jude Bellingham',  price: 7.00, bookmaker: 'William Hill' },
      { name: 'Bruno Fernandes',  price: 8.00, bookmaker: 'Coral' },
      { name: 'Pedri',            price: 9.00, bookmaker: 'Betway' },
      { name: 'Vinicius Jr',      price:10.00, bookmaker: 'Paddy Power' },
    ],
  },
  // ── Manager Markets ─────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    title: 'Premier League — First Manager Sacked 2026/27',
    subtitle: '2026/27 Season — sack race',
    category: 'Manager Markets',
    slug: 'premier-league-first-manager-sacked-2627',
    updatedAt: '2026-06-09',
    outcomes: [
      ...
      { name: 'Enzo Maresca (Man City)', price:15.00, bookmaker: 'Paddy Power' },
    ],
  },
  {
  ...
  {
    id: 'england-manager-exit',
    title: 'England — Next Manager After Euros/WC Cycle',
    subtitle: 'Post-2026 World Cup successor market',
    category: 'Manager Markets',
    slug: 'england-next-manager-2026',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Eddie Howe',         price: 4.00, bookmaker: 'Paddy Power' },
      { name: 'Frank Lampard',      price: 5.00, bookmaker: 'bet365' },
      { name: 'Mauricio Pochettino',price: 6.00, bookmaker: 'Coral' },
      { name: 'Gareth Southgate',   price: 9.00, bookmaker: 'William Hill' },
      { name: 'Thomas Tuchel stays',price:1.50, bookmaker: 'Betway' },
    ],
  },
  // ── Player Awards ───────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    subtitle: 'Annual FIFA award — ceremony Sept 2026',
    category: 'Player Awards',
    slug: 'fifa-best-player-2026',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Kylian Mbappé',   price: 2.75, bookmaker: 'Paddy Power' },
      { name: 'Vinicius Jr',     price: 4.00, bookmaker: 'bet365' },
      { name: 'Erling Haaland',  price: 5.00, bookmaker: 'Coral' },
      { name: 'Jude Bellingham', price: 6.00, bookmaker: 'William Hill' },
      { name: 'Lamine Yamal',    price: 7.00, bookmaker: 'Betway' },
      { name: 'Rodri',           price: 9.00, bookmaker: 'Unibet' },
    ],
  },
  // ── Premier League 2026/27 ──────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    subtitle: 'Season ante-post — not yet started',
    category: 'Premier League 2026/27',
  ...
  {
    id: 'epl-relegation-2627',
    title: 'Premier League — Relegated Club 2026/27',
    subtitle: 'Any of the three relegated teams',
    category: 'Premier League 2026/27',
    slug: 'premier-league-relegated-2627',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Southampton',  price: 1.40, bookmaker: 'Paddy Power' },
      { name: 'Everton',      price: 2.50, bookmaker: 'bet365' },
      { name: 'Brentford',    price: 3.00, bookmaker: 'Coral' },
      { name: 'Ipswich',      price: 3.50, bookmaker: 'William Hill' },
      { name: 'Wolves',       price: 4.00, bookmaker: 'Betway' },
      { name: 'Crystal Palace',price: 5.00, bookmaker: 'Unibet' },
    ],
  },
  // ── Transfer Specials ───────────────────────────────────────────────────────
  {
  ...
  {
    id: 'wirtz-next-club',
    title: 'Florian Wirtz — Club After Summer 2026',
    subtitle: 'Bayer Leverkusen star — heavily linked',
    category: 'Transfer Specials',
    slug: 'florian-wirtz-next-club-2026',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Manchester City', price: 2.00, bookmaker: 'Paddy Power' },
      { name: 'Real Madrid',     price: 3.00, bookmaker: 'bet365' },
      { name: 'Bayern Munich',   price: 4.00, bookmaker: 'Coral' },
      { name: 'Liverpool',       price: 5.00, bookmaker: 'William Hill' },
      { name: 'Barcelona',       price: 7.00, bookmaker: 'Betway' },
      { name: 'Stay Leverkusen', price:10.00, bookmaker: 'Unibet' },
    ],
  },
  {
    id: 'salah-next-club',
    title: 'Mohamed Salah — Club After Summer 2026',
    subtitle: 'Liverpool contract expires July 2026',
    category: 'Transfer Specials',
    slug: 'mohamed-salah-next-club-2026',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Liverpool (renew)', price: 1.80, bookmaker: 'Paddy Power' },
      { name: 'Al-Ittihad (Saudi)',price: 3.50, bookmaker: 'bet365' },
      { name: 'Inter Miami',       price: 6.00, bookmaker: 'Coral' },
      { name: 'Barcelona',         price: 9.00, bookmaker: 'William Hill' },
      { name: 'Retirement',        price:15.00, bookmaker: 'Betway' },
    ],
  },
  {
  ...
  {
    id: 'ucl-top-scorer-2627',
    title: 'UEFA Champions League — Top Scorer 2026/27',
    subtitle: 'Next season ante-post',
    category: 'Champions League 2026/27',
    slug: 'champions-league-top-scorer-2627',
    updatedAt: '2026-06-09',
    outcomes: [
      { name: 'Erling Haaland',   price: 4.00, bookmaker: 'Paddy Power' },
      { name: 'Kylian Mbappé',    price: 4.50, bookmaker: 'bet365' },
      { name: 'Vinicius Jr',      price: 5.00, bookmaker: 'Coral' },
      { name: 'Victor Osimhen',   price: 7.00, bookmaker: 'William Hill' },
      { name: 'Robert Lewandowski',price: 8.00,bookmaker: 'Betway' },
      { name: 'Lamine Yamal',     price:10.00, bookmaker: 'Unibet' },
    ],
  },
];
