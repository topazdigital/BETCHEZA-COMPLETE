...
export const SENIOR_FOOTBALL_TEAMS: CatalogTeam[] = [
  ...
  // ── Croatian HNL (real ESPN IDs) ─────────────────────────────────
  { id: '597',   name: 'Dinamo Zagreb',         aliases: ['gnk dinamo', 'zagreb'],     league: 'HNL', country: 'Croatia' },
  { id: '489',   name: 'Hajduk Split',          aliases: ['hajduk'],                   league: 'HNL', country: 'Croatia' },
  { id: '4413',  name: 'NK Lokomotiva',         aliases: ['lokomotiva'],               league: 'HNL', country: 'Croatia' },

  // ── Serbian SuperLiga (real ESPN IDs) ────────────────────────────
  { id: '2290',  name: 'Red Star Belgrade',     aliases: ['crvena zvezda', 'red star', 'cz beograd'], league: 'SuperLiga', country: 'Serbia' },
  { id: '541',   name: 'Partizan Belgrade',     aliases: ['partizan'],                  league: 'SuperLiga', country: 'Serbia' },

  // ── Greek Super League (real ESPN IDs) ────────────────────────────
  { id: '435',   name: 'Olympiakos',            aliases: ['olympiacos', 'olympiakos pireus'], league: 'Super League', country: 'Greece' },
  { id: '605',   name: 'PAOK',                  aliases: ['paok fc', 'paok salonika'],  league: 'Super League', country: 'Greece' },
  { id: '443',   name: 'Panathinaikos',         aliases: ['panathinaikos fc', 'pao'],   league: 'Super League', country: 'Greece' },
  { id: '887',   name: 'AEK Athens',            aliases: ['aek'],                       league: 'Super League', country: 'Greece' },

  // ── Ukrainian Premier League (real ESPN IDs) ─────────────────────
  { id: '493',   name: 'Shakhtar Donetsk',      aliases: ['shakhtar'],                  league: 'Premier League Ukraine', country: 'Ukraine' },
  { id: '440',   name: 'Dynamo Kyiv',           aliases: ['dynamo kiev', 'dynamo kyiv'], league: 'Premier League Ukraine', country: 'Ukraine' },

  // ── Polish Ekstraklasa (real ESPN IDs) ───────────────────────────
  { id: '555',   name: 'Legia Warsaw',          aliases: ['legia'],                     league: 'Ekstraklasa', country: 'Poland' },
  { id: '2990',  name: 'Lech Poznan',           aliases: ['lech'],                      league: 'Ekstraklasa', country: 'Poland' },

  // ── Austrian Bundesliga (real ESPN IDs) ──────────────────────────
  { id: '519',   name: 'Rapid Vienna',          aliases: ['rapid wien'],                league: 'Austrian Bundesliga', country: 'Austria' },
  { id: '3746',  name: 'Sturm Graz',            aliases: ['sturm'],                     league: 'Austrian Bundesliga', country: 'Austria' },

  // ── Saudi Pro League / Roshn Saudi League (ksa.1 — real ESPN IDs verified) ──
  { id: '817',    name: 'Al Nassr',    aliases: ['al-nassr', 'nassr', 'fc al nassr'],               league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '929',    name: 'Al Hilal',    aliases: ['al-hilal', 'hilal', 'al hilal sfc'],               league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '2276',   name: 'Al Ittihad', aliases: ['al-ittihad', 'ittihad', 'ittihad club'],            league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '793',    name: 'Al Shabab',  aliases: ['al-shabab', 'shabab', 'al shabab fc'],              league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '8346',   name: 'Al Ahli',    aliases: ['al-ahli saudi', 'al ahli sc'],                      league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '8363',   name: 'Al Ettifaq', aliases: ['ettifaq', 'al ettifaq'],                            league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '18459',  name: 'Al Taawoun', aliases: ['taawoun', 'al-taawoun'],                            league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '13033',  name: 'Al Fateh',   aliases: ['fateh', 'al-fateh'],                                league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21827',  name: 'Al Fayha',   aliases: ['al-fayha', 'fayha'],                                league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21964',  name: 'Al Hazem',   aliases: ['al-hazem', 'hazem'],                                league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21829',  name: 'Al Khaleej', aliases: ['al-khaleej', 'khaleej'],                            league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '22028',  name: 'Al Kholood', aliases: ['al-kholood', 'kholood'],                            league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '22023',  name: 'Al Najma',   aliases: ['al-najma', 'najma'],                                league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21966',  name: 'Al Okhdood', aliases: ['al-okhdood', 'okhdood', 'al akhdoud'],              league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '22022',  name: 'Al Qadsiah', aliases: ['al-qadsiah', 'qadsiah', 'al qadsia'],               league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21965',  name: 'Al Riyadh',  aliases: ['al-riyadh'],                                        league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '21828',  name: 'Damac FC',   aliases: ['damac', 'duhail'],                                  league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '130899', name: 'Neom SC',    aliases: ['neom'],                                             league: 'Saudi Pro League', country: 'Saudi Arabia' },

  // ── African giants (real ESPN IDs where available) ────────────────
  { id: '8004',  name: 'Gor Mahia',             aliases: ['gor'],                       league: 'KPL', country: 'Kenya' },
  { id: '18977', name: 'Al Ahly',               aliases: ['ahly', 'al ahly sc'],        league: 'Egyptian Premier League', country: 'Egypt' },
];
