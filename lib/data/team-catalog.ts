...
export const SENIOR_FOOTBALL_TEAMS: CatalogTeam[] = [
  ...
  // ── Saudi Pro League (ksa.1 — real ESPN IDs) ─────────────────────
  { id: '817',   name: 'Al Nassr',              aliases: ['al-nassr', 'nassr'],         league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '929',   name: 'Al Hilal',              aliases: ['al-hilal', 'hilal'],         league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '2276',  name: 'Al Ittihad',            aliases: ['al-ittihad', 'ittihad'],     league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '793',   name: 'Al Shabab',             aliases: ['al-shabab', 'shabab'],       league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '8346',  name: 'Al Ahli',               aliases: ['al-ahli saudi'],             league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '8363',  name: 'Al Ettifaq',            aliases: ['ettifaq'],                   league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '18459', name: 'Al Taawoun',            aliases: ['taawoun'],                   league: 'Saudi Pro League', country: 'Saudi Arabia' },
  { id: '13033', name: 'Al Fateh',              aliases: ['fateh'],                     league: 'Saudi Pro League', country: 'Saudi Arabia' },
